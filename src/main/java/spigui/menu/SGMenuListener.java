...
public class SGMenuListener implements Listener {
     ...
     * associated with the {@link spigui.menu.SGMenu} class (i.e., <code>inventory.getHolder</code>
    ...
    private static boolean shouldIgnoreInventoryEvent(Inventory inventory) {
        ...
        return !(inventory != null &&
                 ...
                 inventory.getHolder() instanceof spigui.menu.SGMenu);
    }
     ...
     * the {@link spigui.menu.SGMenu} inventory belongs to your plugin.
     *
    ...
    public static boolean willHandleInventoryEvent(JavaPlugin plugin, Inventory inventory) {
        ...
        return !shouldIgnoreInventoryEvent(inventory) &&
                Objects.equals(((spigui.menu.SGMenu) inventory.getHolder()).getOwner(), plugin);
    }
     ...
     * SpiGUI {@link spigui.menu.SGMenu} and, if it is, whether a pagination button
     ...
     * <br>
     * The respective inventory is first checked to ensure that it is a
     * SpiGUI {@link spigui.menu.SGMenu} and, if it is, the drag event is captured
     * and cancelled.
     * <br>
     ...
     * {@link spigui.menu.SGMenu#getTag()}.
     *
     * @param event The event to handle.
     * @see SpiGUI#SpiGUI(JavaPlugin)
     */
    ...
    public void onInventoryDrag(InventoryDragEvent event) {
        ...
        // Get the instance of the SpiGUI that was clicked.
        spigui.menu.SGMenu clickedGui = (spigui.menu.SGMenu) event.getInventory().getHolder();
     ...
     * <br>
     * The respective inventory is first checked to ensure that it is a
     * SpiGUI {@link spigui.menu.SGMenu} and, if it is, the close event is delegated
    ...
    public void onInventoryClose(InventoryCloseEvent event) {
        ...
        // Get the instance of the SpiGUI that was clicked.
        spigui.menu.SGMenu clickedGui = (SGMenu) event.getInventory().getHolder();
