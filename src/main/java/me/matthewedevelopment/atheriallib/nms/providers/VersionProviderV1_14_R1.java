...
public class VersionProviderV1_14_R1 extends VersionProvider {
    private NbtAPI nbtAPI;


    public VersionProviderV1_14_R1(AtherialLib atherialPlugin) {
        super(Version.V1_14_R1,atherialPlugin);

        this.nbtAPI = new NbtAPI() {
            @Override
            public Version getVersion() {
                return Version.V1_14_R1;
            }

            @Override
            public VersionProvider getVersionProvider() {
                return VersionProviderV1_14_R1.this;
            }
    ...
    public void sendRawActionBarMessage(Player player, String message) {
        ...
        net.minecraft.server.v1_14_R1.IChatBaseComponent chatBaseComponent = net.minecraft.server.v1_14_R1.IChatBaseComponent.ChatSerializer.a(message);
        net.minecraft.server.v1_14_R1.PacketPlayOutChat packetPlayOutChat = new net.minecraft.server.v1_14_R1.PacketPlayOutChat(chatBaseComponent, net.minecraft.server.v1_14_R1.ChatMessageType.GAME_INFO);
    ...
    public void sendTitle(Player player, String title, String subTitle, int stay, int fadeIn, int fadeOut) {
        net.minecraft.server.v1_14_R1.IChatBaseComponent chatTitle = net.minecraft.server.v1_14_R1.IChatBaseComponent.ChatSerializer.a("{\"text\": \""+ title +"\"}");
        net.minecraft.server.v1_14_R1.IChatBaseComponent subChatTitle = net.minecraft.server.v1_14_R1.IChatBaseComponent.ChatSerializer.a("{\"text\": \""+ subTitle +"\"}");

        net.minecraft.server.v1_14_R1.PacketPlayOutTitle packetPlayOutTitle = new net.minecraft.server.v1_14_R1.PacketPlayOutTitle( net.minecraft.server.v1_14_R1.PacketPlayOutTitle.EnumTitleAction.TITLE, chatTitle);
        net.minecraft.server.v1_14_R1.PacketPlayOutTitle packetPlayOutSubTitle = new net.minecraft.server.v1_14_R1.PacketPlayOutTitle( net.minecraft.server.v1_14_R1.PacketPlayOutTitle.EnumTitleAction.SUBTITLE, subChatTitle);
        net.minecraft.server.v1_14_R1.PacketPlayOutTitle length = new net.minecraft.server.v1_14_R1.PacketPlayOutTitle(fadeIn, stay, fadeOut);
    ...
    public void setBlockSuperFast(Block block, int blockId, byte data, boolean applyPhysics) {
        net.minecraft.server.v1_14_R1.World w = ((CraftWorld)block.getWorld()).getHandle();
        net.minecraft.server.v1_14_R1.Chunk chunk = w.getChunkAt(block.getX() >> 4, block.getZ() >> 4);
