...
public class VersionProviderV1_20_R1 extends VersionProvider {
    private NbtAPI nbtAPI;


    public VersionProviderV1_20_R1(AtherialLib atherialPlugin) {
        super(Version.V1_20_R1,atherialPlugin);
        this.nbtAPI = new NbtAPI() {
            ...
            public VersionProvider getVersionProvider() {
                return VersionProviderV1_20_R1.this;
            }
