 ...
 */
public class VersionProviderV1_13_R2 extends VersionProvider {
    private NbtAPI nbtAPI;


    public VersionProviderV1_13_R2(AtherialLib atherialPlugin) {
        super(Version.V1_13_R2,atherialPlugin);
        ...
        this.nbtAPI = new NbtAPI() {
            ...
            public VersionProvider getVersionProvider() {
                return VersionProviderV1_13_R2.this;
            }
    ...
    public void sendRawActionBarMessage(Player player, String message) {
        ...
        net.minecraft.server.v1_13_R2.IChatBaseComponent chatBaseComponent = net.minecraft.server.v1_13_R2.IChatBaseComponent.ChatSerializer.a(message);
        net.minecraft.server.v1_13_R2.PacketPlayOutChat packetPlayOutChat = new net.minecraft.server.v1_13_R2.PacketPlayOutChat(chatBaseComponent, net.minecraft.server.v1_13_R2.ChatMessageType.GAME_INFO);
    ...
    public void sendTitle(Player player, String title, String subTitle, int stay, int fadeIn, int fadeOut) {
        net.minecraft.server.v1_13_R2.IChatBaseComponent chatTitle = net.minecraft.server.v1_13_R2.IChatBaseComponent.ChatSerializer.a("{\"text\": \""+ title +"\"}");
        net.minecraft.server.v1_13_R2.IChatBaseComponent subChatTitle = net.minecraft.server.v1_13_R2.IChatBaseComponent.ChatSerializer.a("{\"text\": \""+ subTitle +"\"}");

        net.minecraft.server.v1_13_R2.PacketPlayOutTitle packetPlayOutTitle = new net.minecraft.server.v1_13_R2.PacketPlayOutTitle( net.minecraft.server.v1_13_R2.PacketPlayOutTitle.EnumTitleAction.TITLE, chatTitle);
        net.minecraft.server.v1_13_R2.PacketPlayOutTitle packetPlayOutSubTitle = new net.minecraft.server.v1_13_R2.PacketPlayOutTitle( net.minecraft.server.v1_13_R2.PacketPlayOutTitle.EnumTitleAction.SUBTITLE, subChatTitle);
        net.minecraft.server.v1_13_R2.PacketPlayOutTitle length = new net.minecraft.server.v1_13_R2.PacketPlayOutTitle(fadeIn, stay, fadeOut);


        ((org.bukkit.craftbukkit.v1_13_R2.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(packetPlayOutTitle);
        ((org.bukkit.craftbukkit.v1_13_R2.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(packetPlayOutSubTitle);
        ((org.bukkit.craftbukkit.v1_13_R2.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(length);
    }

    @Override
    public void setBlockSuperFast(Block block, int blockId, byte data, boolean applyPhysics) {
        net.minecraft.server.v1_13_R2.World w = ((CraftWorld)block.getWorld()).getHandle();
        net.minecraft.server.v1_13_R2.Chunk chunk = w.getChunkAt(block.getX() >> 4, block.getZ() >> 4);
