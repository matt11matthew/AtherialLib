...
public class VersionProviderV1_15_R1 extends VersionProvider {
    private NbtAPI nbtAPI;


    public VersionProviderV1_15_R1(AtherialLib atherialPlugin) {
        super(Version.V1_15_R1,atherialPlugin);

        this.nbtAPI = new NbtAPI() {
            @Override
            public Version getVersion() {
                return Version.V1_15_R1;
            }

            @Override
            public VersionProvider getVersionProvider() {
                return VersionProviderV1_15_R1.this;
            }
    ...
    public void setBlockSuperFast(Block block, int blockId, byte data, boolean applyPhysics) {
        net.minecraft.server.v1_15_R1.World w = ((CraftWorld)block.getWorld()).getHandle();
