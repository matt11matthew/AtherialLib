 ...
 */
public class VersionProviderV1_9_R1 extends VersionProvider {
    private NbtAPI nbtAPI;

    public VersionProviderV1_9_R1(AtherialLib atherialPlugin) {
        super(Version.V1_9_R1, atherialPlugin);

        this.nbtAPI = new NbtAPI() {
            @Override
            public Version getVersion() {
                return Version.V1_9_R1;
            }

            @Override
            public VersionProvider getVersionProvider() {
                return VersionProviderV1_9_R1.this;
            }
            ...
            public ItemStack removeTag(ItemStack itemStack, String key) {
                net.minecraft.server.v1_9_R1.NBTTagCompound nbtTagCompound = getNbtTagCompound(itemStack);
                net.minecraft.server.v1_9_R1.ItemStack itemStack1 = org.bukkit.craftbukkit.v1_9_R1.inventory.CraftItemStack.asNMSCopy(itemStack);
                if (nbtTagCompound.hasKey(key)) {

                    nbtTagCompound.remove(key);
                }
                itemStack1.setTag(nbtTagCompound);
                return org.bukkit.craftbukkit.v1_9_R1.inventory.CraftItemStack.asBukkitCopy(itemStack1);
            }
    ...
    public void sendRawActionBarMessage(Player player, String message) {
        org.bukkit.craftbukkit.v1_9_R1.entity.CraftPlayer craftPlayer = (org.bukkit.craftbukkit.v1_9_R1.entity.CraftPlayer) player;
        net.minecraft.server.v1_9_R1.IChatBaseComponent chatBaseComponent = net.minecraft.server.v1_9_R1.IChatBaseComponent.ChatSerializer.a(message);
        net.minecraft.server.v1_9_R1.PacketPlayOutChat packetPlayOutChat = new net.minecraft.server.v1_9_R1.PacketPlayOutChat(chatBaseComponent, (byte) 2);
    ...
    public void sendTitle(Player player, String title, String subTitle, int stay, int fadeIn, int fadeOut) {
        net.minecraft.server.v1_9_R1.IChatBaseComponent chatTitle = net.minecraft.server.v1_9_R1.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + title + "\"}");
        net.minecraft.server.v1_9_R1.IChatBaseComponent subChatTitle = net.minecraft.server.v1_9_R1.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + subTitle + "\"}");

        /*
        {"text": ""}
        {\"text\": \"" + text + "\",color:" + ChatColor.GOLD.name().toLowerCase() + "}
         */
        net.minecraft.server.v1_9_R1.PacketPlayOutTitle packetPlayOutTitle = new net.minecraft.server.v1_9_R1.PacketPlayOutTitle(net.minecraft.server.v1_9_R1.PacketPlayOutTitle.EnumTitleAction.TITLE, chatTitle);
        net.minecraft.server.v1_9_R1.PacketPlayOutTitle packetPlayOutSubTitle = new net.minecraft.server.v1_9_R1.PacketPlayOutTitle(net.minecraft.server.v1_9_R1.PacketPlayOutTitle.EnumTitleAction.SUBTITLE, subChatTitle);
        net.minecraft.server.v1_9_R1.PacketPlayOutTitle length = new net.minecraft.server.v1_9_R1.PacketPlayOutTitle(fadeIn, stay, fadeOut);


        ((org.bukkit.craftbukkit.v1_9_R1.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(packetPlayOutTitle);
        ((org.bukkit.craftbukkit.v1_9_R1.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(packetPlayOutSubTitle);
    ...
    public void setBlockSuperFast(Block block, int blockId, byte data, boolean applyPhysics) {
        ...
        net.minecraft.server.v1_9_R1.Chunk chunk = w.getChunkAt(block.getX() >> 4, block.getZ() >> 4);
    ...
    public void hideArrow(Player player, Arrow arrow) {
        net.minecraft.server.v1_9_R1.PacketPlayOutEntityDestroy packetPlayOutEntityDestroy = new net.minecraft.server.v1_9_R1.PacketPlayOutEntityDestroy(((CraftArrow) arrow).getHandle().getId());
