...
public class VersionProviderV1_21_R0 extends VersionProvider {
    private NbtAPI nbtAPI;


    public VersionProviderV1_21_R0(AtherialLib atherialPlugin) {
        super(Version.V1_21_R0,atherialPlugin);
        this.nbtAPI = new NbtAPI() {
            @Override
            public Version getVersion() {
                return Version.V1_21_R0;
            }

            @Override
            public VersionProvider getVersionProvider() {
                return VersionProviderV1_21_R0.this;
            }
